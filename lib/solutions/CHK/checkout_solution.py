...
def checkout(skus):
    ...
    dict_of_deals = {"A": {1 : 50, 3 : 130, 5: 200}, "B": {1 : 30, 2: 45}, "C": {1: 20},
        ...
        "I": {1: 35}, "J": {1: 60}, "K": {1: 80, 2: 150}, "L": {1: 90}, "M": {1: 15}, "N": {1: 40},
        "O": {1: 10}, "P": {1: 50, 5: 200}, "Q": {1: 30, 3: 80}, "R": {1: 50}, "S": {1: 30}, "T": {1: 20},
        "U": {1:40}, "V": {1: 50, 2:90, 3:130}, "W": {1: 20}, "X": {1: 90}, "Y": {1:10}, "Z": {1:50}}
